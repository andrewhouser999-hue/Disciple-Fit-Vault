---
created: 2026-07-24
basis: "Established psychological literature — Spielberger (state-trait theory), Markus (self-schema theory), A.T. Beck / J.S. Beck (cognitive model), Young (schema therapy — Early Maladaptive Schemas and the surrender/avoidance/overcompensation coping-style triad), Bowlby/Ainsworth (attachment theory, Internal Working Models), Porges (polyvagal theory), Bower (mood-congruent/state-dependent processing), Schwartz (Internal Family Systems), Kegan & Lahey (constructive-developmental theory, subject-object), McAdams (narrative identity theory) — original synthesis built for practitioner reference and personal learning; not derived from an existing vault document; updated 2026-07-25 to close a gap in the Preview table — Beck's Tier 2 (intermediate belief) and fourth-element (compensatory strategy) had no CIC-side correspondent — using Young's coping-style triad, which the Character Wound Diagnostic Tool's Warrior/Hermit/False Noble typology already instantiates at trait level and Phase 3's Schema Interruption Practice already instantiates per-incident; updated 2026-07-26 to flag a failure mode in the downward-arrow technique as taught in Framework 3 — pure implication-chasing questioning often skips past Tier 2 to Tier 3 — pointing to the new Elicitation Technique section in [[Covenant Identity — Cognitive Diagnostic Fluency Curriculum]] for the corrective lateral move"
tags: [practitioner-reference, psychology, theory, identity, cognitive-model, reference-and-learning]
---
...
flowchart TB
    ...
    subgraph TR["TRIGGER-ACTIVATED CONTENT — state-dependent, situational"]
        ...
        B4["Activated Internal Working Model <br/>(Bowlby / Ainsworth)"]
        B5["Neuroception-driven autonomic state <br/>(Porges)"]
        B6["Mood-congruent retrieval <br/>(Bower)"]
...
```mermaid
flowchart LR
    CB["Core Belief <br/>(Tier 3) <br/>'I am inadequate'"] --> IB["Intermediate Belief <br/>(Tier 2) <br/>'If I fail, others will lose respect for me'"]
    IB --> CS["Compensatory Strategy <br/>(4th element) <br/>perfectionism, over-preparation, avoidance"]
    CS --> SIT["Situation <br/>strategy fails or is unavailable"]
    SIT --> AT["Automatic Thought <br/>(Tier 1) <br/>'They think I'm incompetent'"]
    AT --> RX["Reaction <br/>emotional / behavioral / physiological"]
```
