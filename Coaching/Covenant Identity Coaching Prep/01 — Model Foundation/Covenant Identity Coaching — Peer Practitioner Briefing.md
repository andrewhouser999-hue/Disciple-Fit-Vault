...
```mermaid
flowchart LR
    A["New Birth (assumed)"] --> B["Identity Formation — done FIRST"]
    B --> C["Behavior"]
    B --> D["Mission / Calling"]
    B --> E["Spiritual Disciplines"]
```
