...
The Identity Installer gives you the what — a declared identity, anchored in Scripture, tied to behavioral intention. This worksheet addresses why it doesn't land and how to make it consolidate.

Three gaps the Installer doesn't address on its own:

- **The blocking schema** — every identity category has a corresponding psychological structure that resists it. The schema doesn't argue against the identity statement; it creates an emotional climate where the statement feels false. Naming what's blocking reception is as important as naming what's true.
- **The evidence story** — lists of evidence stay abstract. Identity consolidates when the evidence becomes a narrated story — something specific that happened, that you can inhabit again. A story is retrievable under pressure in a way a list is not.
- **The identity vote** — identity isn't only declared, it's enacted. Each time you act from your stated identity — especially when the blocking schema is pushing against it — you cast a vote for who you are. Those votes accumulate into lived conviction. Without them, the identity statement stays in the mind and never moves into the body's sense of self.

**How to work through this:**
1. Complete Parts 1–3 in one sitting (30–45 minutes). Don't rush Part 3 — the evidence story is where most of the work happens.
2. Design and run the identity vote in Part 4 during the week.
3. Fill in the Part 4 debrief after the vote.
4. Bring the completed sheet to your next session.

---

## Part 1 — The Identity Claim (Declaration Layer)
...
**What I'm Putting Off** *(the old identity I've been living from):*
>

**What I'm Putting On** *(the identity I'm choosing):*
>

---

## Part 2 — The Blocking Schema (Psychological Layer)

Every identity category has a corresponding schema that resists it. The schema doesn't argue against your identity statement — it creates an emotional climate where the statement feels false, irrelevant, or naively optimistic. Naming it is not defeat; it's precision.
...
|---|---|
| Defectiveness / Shame | Makes identity statements feel undeserved — "this applies to others, not to me" |
| Abandonment / Instability | Makes statements about being chosen or loved feel contingent — "for now, maybe" |
| Emotional Deprivation | Makes statements about being known or cared for feel hollow — "no one actually sees me" |
| Unrelenting Standards | Accepts the identity in principle, then immediately asks "but am I living up to it?" |
...
**The blocking schema for this identity category:**

**What it says when I speak my identity statement:**
>

**How it processes my evidence** *(minimizes, explains away, adds a "but...", finds the exception):*
>

**My activation signal** *(what happens in my body when the schema overrides the identity statement):*

**My interruption:** *"That's my \_\_\_\_\_\_\_\_\_ schema talking. It is not the measure of this."*

---

## Part 3 — The Evidence Story (Narrative Layer)

Lists of evidence stay abstract. Identity consolidates when the evidence becomes a narrated story — something specific that happened, that you can inhabit again. A story is retrievable under pressure in a way a bullet point is not.

*Don't summarize. Tell it. What happened? Where were you? What did you do or experience that is evidence this identity is real? Write in first person, past tense, with enough detail to re-enter it.*

**There was a time when...**
>

*(If nothing comes immediately: what is the smallest, most specific moment you can point to where this identity was true? It doesn't need to be dramatic.)*

**What this story reveals about who I am:**
>

**When the blocking schema tries to dismiss this story, it says:**
>
...
**My identity vote this week:**
*(One specific action that enacts this identity. Not a general intention — a concrete thing you will do, in a specific context, with a person or situation you can name.)*
>

**What makes this a vote for this identity specifically:**
>

**What the blocking schema will likely say before, during, or after:**
>

**What I will say back:**
>

---

### Debrief *(fill in after the vote)*
...
**What the blocking schema did with it** *(minimized the result, reframed it, went quiet, pushed back harder):*
>

**What this vote adds to my evidence story:**
>

**What I know about this identity now that I didn't know before I acted:**
>
...
**Who in my life reflects this identity back to me accurately?**
*(Who sees me as who God says I am in this area?)*
>

**Who distorts it?**
*(Who — by what they say, how they treat me, or what they expect — reinforces the blocking schema or the old identity?)*
>

**What I may need to do differently in those relationships:**
>

---

## Part 6 — The Felt Sense + Daily Practice

**Where this identity lands in my body** *(when I speak it from a calm place — where do I feel it physically?):*
>

*If you don't feel it yet: notice any small physical response. The felt sense develops over time through repetition and through the identity vote debrief. It is not something to manufacture.*

**The word or phrase that captures it:**
>

---

### Daily Practice *(short and repeatable — for every morning)*

The worksheet is weekly work. The daily practice is short. Distill this identity down to one sentence and one verse. Speak them aloud. Locate the felt sense. That's it.

**My daily statement:**
*(One sentence. First person. Present tense. Specific enough to be yours.)*
>

**My anchor verse:**
>

*When I speak it, I will pause and notice: where it lands, what the blocking schema says, whether I can let it be true for thirty seconds.*

---

## Part 7 — Reflection Prompts *(bring to your next session)*

1. When did the blocking schema show up this week in relation to this identity? What triggered it?
2. Did you return to the evidence story? Was it retrievable? Did it feel different the second or third time?
3. What happened with the identity vote? What did the schema do with the result?
4. Is the identity statement landing differently than when you first wrote it?
5. What is the blocking schema still saying? What evidence is it still using?

---

*This worksheet is for between-session work in Phases 3–4 of the Covenant Identity engagement. Work one identity category per worksheet — not all twenty-two. The coach identifies which category is most live given the Phase 2 wound map and the Phase 3 declaration work underway. The identity vote debrief and the evidence story are the primary material for the following session.*

---

### Coach Note — Opening the Following Session

Open with the identity vote debrief — not the declaration, not the felt sense, not a general check-in. The vote generated lived behavioral evidence. That is the highest-leverage entry point.

Opening questions:
- "What did you do?"
- "What happened?"
- "What did the blocking schema do with it?"
