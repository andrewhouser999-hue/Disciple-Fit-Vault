...
| Asset | Status per vault | Check before launch |
|---|---|---|
| Coaching Agreement | Signable, terms finalized 2026-07-28 ($1,680 / 12 sessions, or 3×$560) | Ready — no action |
| Stripe Payment Link | Referenced as built in the Two-Tier Intake Protocol | Confirm the link is live and the amount matches |
