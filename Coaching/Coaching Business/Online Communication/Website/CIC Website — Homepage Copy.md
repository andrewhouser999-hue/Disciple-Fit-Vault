...
# CIC Website — Homepage Copy

**Channel role:** Conversion layer (Buyer's Journey Stages 4–5), per the resolved systems architecture — Disciple Fit's video/social content carries Stages 2–3 (Recognition/Curiosity); this page picks up once a visitor already feels recognized. Segment: The Wilderness Christian (Target Market, promoted 2026-09-09).

**Status:** Working draft, assembled from the current best version of each section across source docs. Two sections carry open flags — see inline notes. Not yet tested against real prospect language (Hypothesis-level per its own sourcing).
...
**[ Find Your Starting Point ↓ ]** — scrolls to the doorway section below; not a discovery-call ask yet.
