...
1. A short video (3–5 min, phone-filmed, conversational — not polished production)
2. One specific task or action
3. A reflection prompt inviting sharing or accountability

**Facilitation at scale:** Async works for 50–300 participants. Pre-record all videos. Respond once daily to community posts. Add one live call at Day 3–4 — this single live touchpoint boosts completion significantly. Total coach time: ~30 min/day.
...
| With documented results | $97–$197 | Filter serious buyers, higher per-cohort revenue |
| Established proof + warm audience | $297–$497 | Premium positioning |

**Never launch first challenge above $97.** Underperforms without social proof.
...
- Using Skool or Mighty Networks (community platforms, not cohort platforms — drops completion 15–35%)
...
- "From Stuck to Aligned: Clarity on God's Call in 7 Days"
- "Breaking the Shame Cycle: CBT + Biblical Truth"
- "Rewriting Your Story: From Victim Narrative to Victor Narrative"

The CBC combination (CBT + Coaching + Biblical framework) is rare in the market. That differentiation belongs in the challenge title and the offer.
...
4. Teaching: biblical framework + psychological principle — 20 min
5. Closing commitment + accountability setup — 10 min

**Between calls (async):** Daily or 3x/week reflection prompt by email. Private community (Circle, Slack, or Mighty Networks) for peer support. Optional async voice memo coaching.
...
| Tier | Price | Includes |
|---|---|---|
| Starter | $497–$697 | Weekly calls + community |
| Standard | $897–$1,497 | Weekly calls + async coaching + community |
| Premium | $1,497–$2,497 | All above + monthly 15-min 1:1 check-ins |
...
1. Waitlist page (not sales page) — shows transformation framing, who it's for/not for, format, start date, price, single CTA
2. 3-email warm sequence to existing list
3. Free webinar on challenge-related topic → offer group at the end
4. 10-day cart-open email sequence (5–7 emails, closes with urgency)
5. Pre-qualification: 3–4 question application form (raises perceived value, reduces early dropout)
...
- Capped at 12–15 participants
- Same call day/time every week; all 8 dates sent on Day 1
- Coach responds to all community posts daily with coaching questions, not just answers
- Week 1 produces a visible, immediate win — if transformation waits until Week 5, participants leave by Week 3
- Accountability buddy pairs set at enrollment
- 8-week curriculum roadmap distributed on Day 1
- Post-program path announced by Week 6 (alumni community, next cohort, 1:1 offer)

**Top three group killers:**
1. Inconsistent call schedule
...
| **Circle.so** | Group coaching + community | $99–$499 |
| **Kajabi** | Full product ladder (challenge → group → course) | $119–$319 |
| **Mighty Networks** | Community-first, peer connection | $99–$1,999 |
| Slack + Zoom + Email | First group, lean launch | ~$6–12/person/mo |

For a first group, Slack + Zoom + email is functional and zero risk. Move to Circle or Kajabi when the model is proven.
...
Paid Challenge ($47–$97, 7 days)
        ↓  20–28% convert
Group Coaching Program ($1,197–$1,497, 8–12 weeks)
        ↓  40% of completers convert
1:1 Coaching or Alumni Group (recurring)
```

The challenge validates content, builds the list, generates testimonials, and pre-qualifies buyers. The group delivers the transformation and builds recurring revenue. The 1:1 becomes selective and high-ticket — not the entry point.

**Right sequence:** Run the first challenge before building the full group program. The challenge proves what content lands, who the actual buyer is, and produces testimonials to fill the first cohort.
