---
created: 2026-08-25
basis: "[[Covenant Identity — Biblical Foundations Index]] Sections 1-5 (governing frame, diagnostic layer, content layer, telos, implementation layer); [[Covenant Identity — Functional vs. Confessional Theology — 20 Diagnostic Contrasts]]; [[Covenant Identity — The Biblical Pattern of Self-Declaration — Practitioner Exegetical Reference]]; [[Covenant Identity Coaching — Peer Practitioner Briefing]] §1 (Category 6 — Inner Man / Christ's mission statement, not yet in the Index); [[Covenant Identity — Whole-Person Identity Framework]] (Matthew 22:37 double-duty note); [[Covenant Identity — The Interior Life as Telos]] (Psalm 42 double-duty note); 2026-09-01 /bible research — inner man/heart lexical bridge (Eph 3:16-17), Hidden Heart text cluster (Category 7: Ps 19:12, Prov 20:5, Heb 4:12, Heb 4:16); 2026-09-02 — Ancient Near Eastern suzerain-vassal treaty note under Exodus 20:2 (treaty form per Mendenhall/Kline, read through [[covenant_framework_definition]]/Gentry & Wellum's Kingdom Through Covenant); [[Covenant Identity — The Inner Man — Biblical Foundations and Position Paper]] (2026-09-02) — closes Category 7 into the Index as Developed, adds the guardable-heart counter-tradition (Prov 4:23, Deut 8:2, 1 Kings 8:38) correcting this category's original opacity-only framing"
tags: [coaching-me, covenant-identity, scripture-memory]
---

# Covenant Identity — Central Verses for Memorization
...
**How to use:** Seven categories. The first five mirror the Biblical Foundations Index's own sections. The sixth (Inner Man) draws from [[Covenant Identity Coaching — Peer Practitioner Briefing]] §1 and is still not its own Index row. The seventh (Hidden Heart) was developed into [[Covenant Identity — The Inner Man — Biblical Foundations and Position Paper]] (2026-09-02) and is now Category 2's Section 2 row in the Index, Developed status — the paper also corrected this category's earlier framing, which cited only the heart's opacity and missed the guardable-heart counter-tradition (Prov 4:23, Deut 8:2, 1 Kings 8:38); read the paper, not just this file's own notes, for the corrected case. Memorize category by category — each category's texts build a single argument, so they hold together better in memory as a set than individually.

---

## 1. Governing Frame — why identity precedes behavior

**Exodus 20:2** — "I am the LORD your God, who brought you out of the land of Egypt, out of the house of slavery."
*Covenant grammar: indicative before imperative — identity declared before behavior required.*

**The Ancient Near Eastern suzerain-vassal treaties.** Exodus 20:2 has two parts, in a fixed order, before a single command is given in v.3: a preamble naming who is speaking ("I am the LORD your God") and a historical prologue naming what that speaker has already done ("who brought you out of the land of Egypt, out of the house of slavery"). Only after both does the text move to the Ten Commandments themselves (vv.3-17). This two-part shape — self-identification, then a rehearsal of the ruler's prior acts, then the obligations — is the standard form of Ancient Near Eastern suzerain-vassal treaties, the diplomatic covenant documents by which a great king bound a lesser king to himself (documented by Mendenhall and developed at length by Meredith Kline; the same treaty-form reading undergirds Gentry & Wellum's *Kingdom Through Covenant*, the primary framework anchor for this practice — see [[covenant_framework_definition]]). Naming Exodus 20:2 as an instance of this form is not a stretch: the parallel in structure between Sinai and the Hittite treaties is one of the best-established form-critical observations in Old Testament covenant scholarship.

Why this is worth carrying by memory, specifically for explaining the model to someone new to it: it makes "identity before behavior" visible as the text's own grammar, not a theological inference laid on top of it. The order in Exodus 20:2 cannot be rearranged without breaking the form — God does not say "obey these commands and I will become your God and rescue you." He says "I am your God; I have already rescued you" — completed, past tense — and only then gives the commands. A listener does not have to take your word for that order; they can see it in the verse itself, which is why this is the text to start with when teaching the governing frame, ahead of Philippians 2:12-13 and Romans 6:11 (which assume this same order but don't display it as visibly).
...
## 3. Content Layer — the architecture's hinge texts

**Galatians 3:27** — "For as many of you as were baptized into Christ have put on Christ."
*Union with Christ — the legal/spiritual basis for every identity claim in the model.*

**Romans 8:1** — "There is therefore now no condemnation for those who are in Christ Jesus."

**Ephesians 1:3** — "Blessed be the God and Father of our Lord Jesus Christ, who has blessed us in Christ with every spiritual blessing in the heavenly places."
*Present-tense declared realities, not aspirations.*

**2 Corinthians 3:18** — "And we all, with unveiled face, beholding the glory of the Lord, are being transformed into the same image from one degree of glory to another. For this comes from the Lord who is the Spirit."
*Does double duty — the Image-bearer architecture anchor and the primary mechanism text for the telos itself.*
...
*Reported first-person declaration, deployed at the point of maximum distress — the cleanest textual match to the practice itself.*
...
**Self-opacity, defined:** the structural inability of a system — human or artificial — to fully inspect, verify, or report on its own internal states and processes. Not simply ignorance of external facts, but a constitutive limitation: the act of inspection is itself part of the system being inspected, so no vantage point exists from which total, verified self-access could occur even in principle. This holds independent of how much a person can or can't report at any given moment — self-opacity is not a degree of access, it is the structure access happens within.
...
*The counter-tradition this category originally missed. *Nāṣar* ("keep, guard") is covenant-guarding language — the same verb used for guarding a city or the commandments — a posture of vigilant responsibility toward what flows out, not a claim of exhaustive introspective access to what lies within. Guarding the heart and being structurally unable to fully inspect it are not in tension; vigilance is the appropriate response to structural opacity, not evidence against it.*

**Deuteronomy 8:2** — "that he might humble you, testing you to know what was in your heart, whether you would keep his commandments or not."
*The testing is explicitly *for the purpose of* Israel coming to know their own heart — which presupposes they didn't already know it. Self-knowledge here is produced through trial over time, not a standing capacity exercised at will.*

**1 Kings 8:38** — "whatever prayer, whatever plea is made by any man or by all your people Israel, each knowing the affliction of his own heart..."
*Assumes real, actionable self-knowledge — enough to pray specifically — without that knowledge ever claiming the completeness only a genuinely external inspector (God, per Jer 17:10) could supply. Opacity is structural, not a matter of degree: this verse shows opaque self-knowledge that is nonetheless real and usable, not opacity being overcome.*

**Hebrews 4:16** — "Let us then with confidence draw near to the throne of grace, that we may receive mercy and find grace to help in time of need."
*Andrew's own observation (2026-09-01): "drawing near" names the human-side posture — the condition the person creates — that the preceding verse's Word-work and the Spirit's work operate within. Correction (2026-09-02): the module's "conditions" language is not actually ungrounded — [[Covenant Identity — Conditions for the Spirit's Sanctifying Work]] already exists (built 2026-06-16, governed by Phil 2:12-13) and already covers the human-posture side via Luke 11:9-13 and Gal 3:2, 5. Heb 4:16 is a candidate addition to that document's existing Petitionary/Receptive category, not a fill for a real gap.*

*Resolved 2026-09-02 in [[Covenant Identity — The Inner Man — Biblical Foundations and Position Paper]] — read there for the full case, summarized here: **(1) These four verses are not the whole picture.** This category originally cited only the heart's opacity; a /scrutinize pass found it had never been tested against Scripture's equally-canonical guardable-heart tradition (Prov 4:23, Deut 8:2, 1 Kings 8:38). The paper's position: self-opacity is structural (no creature is external to itself; only God, per Jer 17:10, is) rather than a matter of degree. Culpable self-deception (Rom 1:18; Prov 21:2) is a distinct layer stacked on that structural limit, not a repetition of it. **(2) Container vs. aspectival** — resolved as aspectival: "heart," "mind," "spirit," "soul," "conscience" are overlapping vocabularies naming the same whole person from different angles, not components stacked inside a person. **(3) Referent vs. concept** — these texts describe the same kind of person modern psychology describes, not the same mechanism (encoding, procedural memory, reconsolidation); treat the correlation as real at the level of the phenomenon, not proof the biblical authors meant "implicit memory" in the clinical sense. Status in the Biblical Foundations Index: Developed.*

---

*31 verses total (32 entries — Philippians 2:12-13 appears twice: the ESV text and the CIC working paraphrase used in client-facing material). Wording is ESV, transcribed from the source documents above — cross-check against ESV.org before quoting in client-facing or public material, per the same standing caution on [[Daily Encouragement Scriptures (ESV)]].*
