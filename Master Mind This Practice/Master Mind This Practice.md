...
Read 1 file, listed 1 directory, recalled 7 memories (ctrl+o to expand)

● Based on what's built up across your practice, "formative" splits cleanly by track — here's the map:

Covenant Identity Coaching — Theological/Formation Stack

  This is the practitioner-formation layer (why the framework is true, how change actually works), distinct from the CIC session-tool author seating:

  - Covenant structure: Gentry & Wellum (Kingdom Through Covenant), Goldsworthy — grounds "covenant" as biblical-theology category, not Reformed systematics
  - Telos: Christopher Wright (Mission of God), Plantinga (Not the Way It's Supposed to Be)
  - Anthropology: Bavinck (practitioner-only, dense)
  - Formation methodology — the single most load-bearing figure: Dallas Willard (Renovation of the Heart, Spirit of the Disciplines, Divine Conspiracy). His VIM framework (Vision → Intention → Means) and "disciplines as conditions, not causes" is the reason your tools (Lie Eliminator, Identity Installer) work the way they do.
  - Grace-forward change theory: Keller (Prodigal God, Counterfeit Gods), Bridges (Discipline of Grace), Fitzpatrick Miller/Serge Sonship
  - Operational change: Powlison (theoretically primary) and Tripp (operationally seated in your actual worksheets — but flagged for a legalistic tendency, always paired with the grace-forward names above)
  - Affections: Jonathan Edwards (Religious Affections), Thomas Chalmers (Expulsive Power of a New Affection — most undervalued, single-sermon, highest client-facing applicability)
  - Psychological mechanism (subordinate): Ed Welch, Curt Thompson, Siegel (mechanism only, not telos)
  - Character diagnostic: Dan Allender
  - Epistemological bridge: Eric Johnson (Foundations for Soul Care)

  Session-tool-specific (different system, direct client-facing seating): N.T. Wright, Sinclai Ferguson, O.P. Robertson, plus Henri Nouwen (Life of the Beloved — Taken/Blessed/Broken/Given as the mechanism under Manning's "beloved is the true self" one-liner) and Gendlin/McMahon & Campbell (Focusing → Bio-Spiritual Focusing, seated as Stage 4b's body/felt-sense route).

  RPA (Relational Performance Advisory) Evidence Base

  Named directly in your CLAUDE.md governing protocol — secular, non-clinical, organizational context: Perry (neurosequential/trauma-informed), Siegel (interpersonal neurobiology), Rock (SCARF/neuroleadership), Kegan & Lahey (adult development, immunity to change), Miller & Rollnick (motivational interviewing), Kolb (experiential learning), Prochaska (stages of change), Bloom/SAMHSA (trauma-informed care), plus hospitality-industry research.
...
The logic: "seek first the kingdom" is the key, but the lock is inner obstructions. Most formation work adds more truth without addressing the filter. You stand for removing the filter — not just teaching the principle, but freeing the affections to actually hold it.

The Word of God working with the Holy Spirit is the driving mechanism for cognitive restructuring. Intrinsic work works with others and in experience with and prayer with the Holy Spirit.  Learning how to heal on a biblical framework. 

*Covenant Identity Coaching Model - CBC adaptation:* Replace "naturally whole" with "bears the image of God and therefore has genuine agency, creativity, and worth." Coaching confidence rests in what God has already placed in the client — not in the client's autonomous self-sufficiency.

Affections as the mechanism — Clearing the inner man so the affections can be freed to hold Heaven First. This is Augustinian love-ordering language applied practically to a coaching context. No one at the popular level owns this combination. A coaching system that actually does the work — Rohr teaches the concept. Willard teaches the concept. You're building the methodology that implements it. That's a real gap.
...
Jack Mezirow's Transformative Learning Theory is the most relevant adult education framework. Mezirow argues that adult learning worth the name is frame of reference transformation, not content accumulation. Transformation requires:
  ...
  - Critical self-reflection on underlying assumptions (not just content)
...
**What Western Christianity Actually Misses** 
  ...
  1. Primarily propositional transmission — sermons, Bible studies, small groups are almost entirely information transfer. The formation mechanism is assumed to be cognitive assent to correct doctrine.
  2. No body-level training — with the exception of some liturgical traditions, Western Protestant Christianity has largely abandoned bodily disciplines as a formation category (Willard's diagnosis).
  3. Emotional detachment from truth — worship in many evangelical contexts is either entertainment or intellectual exercise — not the emotionally engaged repetition that neuroplasticity requires.
  4. No schema or God-representation work — no structure for surfacing distorted God-representations or correcting the emotional/relational substrate of belief.
  5. Attendance without practice — church attendance is not a community of practice in the Lave & Wenger sense. It does not involve legitimate peripheral participation in a shared practice — it involves passive reception.
...
Coaching Tools for Community Equipping [SESSION-TOOL]
  ...
  1. Social Support Mapping
  Visual mapping of existing network: who is present, quality of relationship, directionality (who gives, who receives), alignment with growth direction. Identifies gaps. Not proprietary — general coaching practice.

  2. Values Clarification Applied to Community
  What kind of community does this person actually need — not just prefer? Values clarification helps identify: growth-oriented vs. comfort-oriented peers, accountability vs. affirmation-only dynamics, whether current community reinforces the old identity narrative or supports the new one.

  3. GROW Applied to Community Engagement as a Goal
  Community engagement treated as a goal in the coaching agenda — Goal (what kind of community?), Reality (what exists?), Options (where could this be found?), Will (what specifically, by when?). Prevents community from remaining abstract.

  4. MI Discrepancy Development for Community Ambivalence
  Most isolated Christians have significant ambivalence about community — they want it but have been hurt, are afraid of vulnerability, or have  a distorted God-representation that predict rejection in relational settings. MI's discrepancy technique: explore the gap between "I want to grow" and "I am avoiding the relational conditions that make growth possible." Let the client name the discrepancy.

  5. Externalizing the Community Narrative (Narrative Therapy)
  "When did you decide community wasn't safe/worth it/available to you?" Makes the isolation narrative visible and separable from the client's identity.
 

Strong inference.
  - Ritual repetition as implicit encoding. Daily declaration, Scripture meditation, structured prayer — these are repeated practices that encode truth procedurally over time, the same mechanism as habit formation but with a relational and Spirit-mediated layer. This is exactly coach-safe implicit work. You're not processing what's encoded; you're building new encoding through practice.
  - God as corrective attachment experience. For clients with sub-clinical insecure attachment patterns — the anxious, avoidant, mildly  disorganized — experiential engagement with God as a non-abandoning, fully-attuned presence reorganizes attachment implicit priors over time. Facilitated through prayer and Scripture (not trauma narrative), this stays firmly inside coaching scope while reaching implicit level.
  - The Spirit as the gap-closer. The explicit-to-implicit gap is real. What the biblical framework claims — and what secular tools cannot replicate — is that the Spirit makes truth land at the experiential level. This is illumination, not just comprehension. If that's operative,you're not doing the implicit work yourself; you're creating conditions for the Spirit to do it. **That changes what "coach-safe" means — you're not claiming to rewire; you're facilitating participation in a Spirit-led process.**

Strong inference: The honest claim is: Regeneration creates the capacity for transformation; the tools and practices are means through which the Spirit works that transformation; the trajectory is genuine reorganization; the rate and degree depend on engagement and the nature of the wound. That's defensible. "Born-again believers fully recover" as a general claim is not.  population-level study. The evidence is case-level and narrative.
...
God loves with a covenant. No conditions need to be met from the receiving party.  The covenant is permanent.  
...
My breakthrough is not just coming to me, its coming through me. Position yourself to receive it, structure yourself to sustain it. It's spiritual and natural, its prayer and action, its faith and follow through, 

The great flip from Satan's time to the Saint's time. 

The world is filled by sin and compromise. The Kingdom runs on the Spirit. When righteousness and creativity merge, when strategy and Holiness align, when obedience and innovation come together the Kingdom rules the world with divine momentum. 

When the church aligns with the Spirit and takes the world by force causing an divine alignment the Church will be unstoppable. This is time. 

Build to transform the next generation. Study your lane, build skills, building leverage which is value on demand. Walk in excellence. Build not just for likes but for legacy, not for applause but for alignment with eternity. 
...
- Measure Spiritual **Maturity** by *Beatitudes*
	- Stages of Faith
- *Greatest Commandment* - Encouraged, aligned, made resilient, relational and lifted up by **Love**
- *Seek First* the Kingdom of Heaven - Essentials for life **Success**
- *Covenant Identity* - Gaining **Alignment** with your true self and with God
- Holy Spirit Relationship - **Experiencing** God
- God's community - **belonging** your peeps 
- *Courageous-faith filled living* beyond natural authority and laws increasingly **becoming** your **Whole Person**.
- Jesus walked His disciples to a place they were willing to take the most cruel death in defense of their faith. He is walking you to a place where instead death dies fully in you, you are your most Whole person.  Run the race this way to win these are the essentials the imperatives.
