...
| **Gallup** | Workplace consulting/analytics — Omaha-founded, still runs a major Omaha campus; Business Development Consultant is consultative enterprise B2B sales (matches Schwab long-cycle trust-building + FOX 42 enterprise ad accounts); Learning and Development Consultant matches the onboarding-curriculum-from-scratch pattern at Schwab and Ecowater directly | Partially vetted 2026-07-31 — web-search pass only, not a real LinkedIn-login or CourtListener query: no 2025–2026 layoff/restructuring reports surfaced; company is private and employee-owned (ESOP) since 1935, so no 10-K/10-Q exists — financial-reality check doesn't apply the way it does for public companies; no wage/commission litigation surfaced but this was a shallow web search, not an actual CourtListener docket search; could not confirm BD/consulting leadership tenure specifically (only found CEO Jon Clifton since 2022, President/COO Jane Miller — a 2022 CEO transition from longtime CEO Jim Clifton is worth asking about in-interview, not disqualifying); repost-frequency history not found (job boards don't surface posting-history data via search) | Two live Omaha-relevant reqs found 2026-07-31: [Business Development Consultant](https://job-boards.greenhouse.io/gallup/jobs/4080330009) → lead with `Andrew Houser — B2B Sales Career Profile.md`; [Learning and Development Consultant](https://job-boards.greenhouse.io/gallup/jobs/4114980009) → lead with `Andrew Houser Resume - Sales Enablement.md`. Real leadership-tenure and litigation checks still need your LinkedIn login and a direct CourtListener query — do those before applying, don't treat this pass as the full checklist |
